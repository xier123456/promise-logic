...
return results`
    },
    {
      ...
      description: 'Use maxTimer with custom instance',
      initialCode: `// Use maxTimer with custom instance
const logic = createPromiseLogic({ prefix: 'async' })

try {
  const result = await logic.asyncOr([
  ...
  return (
    <div className="w-[90%] sm:w-[75%] mx-auto">
      ...
      <div className="prose prose-lg text-gray-600 dark:text-gray-300 dark:prose-invert max-w-none mb-12">
        ...
        <p>
          All methods in custom instances return <code>PromiseWithTimer</code> instances which wrap native Promise and provide additional functionality like timeout control.
        </p>
      </div>
      ...
      <div className="mb-12">
        ...
        <ReturnValue 
          description="Returns a custom PromiseLogic instance containing configured methods. All methods return PromiseWithTimer instances."

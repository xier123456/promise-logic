...
async function basicAndExample() {
  // Succeeds when all operations succeed
...
await basicAndExample();`
    },
    {
      title: 'Basic OR Logic',
      description: 'Returns the first successful Promise, equivalent to Promise.any()',
      initialCode: `// Basic OR Logic Example
import { PromiseLogic } from 'promise-logic';

async function basicOrExample() {
  // Returns the first successful service
...
await basicOrExample();`
    },
    {
      title: 'Basic RACE Logic',
      description: 'Returns the first completed Promise (regardless of success or failure), equivalent to Promise.race()',
...
async function basicAllSettledExample() {
...
async function complexLogicExample() {
  ...
  const registrationSteps = [
    ...
    checkUsernameUnique(),   // Check username uniqueness
  ...
  try {
    ...
    const results = await PromiseLogic.and(registrationSteps);
      ...
      <div className="w-[90%] sm:w-[75%] mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-6">
            ...
            <ul className="text-yellow-700 dark:text-yellow-400 text-sm space-y-2">
              <li>• Ensure PromiseLogic is properly installed following the <a href="/docs/installation" className="underline">Installation Guide</a></li>
              <li>• Familiar with basic JavaScript Promise concepts</li>
              <li>• Understand the fundamentals of asynchronous programming</li>
        ...
        <div className="mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            The following examples showcase PromiseLogic's four most commonly used logic gate operations.
        ...
        <div className="mb-12">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
            ...
            <ul className="text-gray-600 dark:text-gray-300 text-sm space-y-2">
              <li>• Check <Link href="/docs/CoreLogicGate_api/and" className="text-blue-600 dark:text-blue-400 underline">AND Logic Documentation</Link> for detailed usage</li>
              <li>• Explore <Link href="/docs/CoreLogicGate_api/or" className="text-blue-600 dark:text-blue-400 underline">OR Logic Documentation</Link> to learn service degradation strategies</li>
              <li>• Learn <Link href="/docs/CoreLogicGate_api/xor" className="text-blue-600 dark:text-blue-400 underline">XOR Logic</Link> to implement mutually exclusive operations</li>
              <li>• Understand <Link href="/docs/CoreLogicGate_api/allSettled" className="text-blue-600 dark:text-blue-400 underline">ALLSETTLED Logic</Link> for result analysis</li>
            </ul>
          </div>
        </div>
